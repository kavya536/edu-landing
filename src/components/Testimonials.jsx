    ...
    <section ref={sectionRef} className="pt-20 pb-32 px-6 md:px-12 bg-white scroll-mt-20" id="testimonials">
      <div className="max-w-screen-2xl mx-auto">
        ...
        <div className="max-w-3xl mb-16 text-center mx-auto">
          <h2 className={`text-[28px] md:text-[32px] font-serif font-bold text-[#202020] mb-4 leading-tight transition-all duration-1000 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            Success <span className="italic font-normal text-gradient pr-2">Stories</span>
          </h2>
          <p className={`text-slate-400 text-[18px] leading-[1.6] transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Hear from our global community of achievers who have transformed their academic careers.
          </p>
        </div>

        <div className="flex flex-col md:flex-row gap-12 items-start">
          {/* Left Side: Image */}
          <div className={`w-full md:w-5/12 relative mx-auto md:mx-0 transition-all duration-[1200ms] transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          ...
          {/* Right Side: Content */}
          <div className={`w-full md:w-7/12 text-left transition-all duration-[1200ms] transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
            <div className="space-y-10">
              <div className={`transition-all duration-1000 delay-300 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
                <p className="text-[20px] font-serif italic text-[#808080] leading-[1.6] mb-6">
                ...
                <div className="flex items-center justify-center md:justify-start gap-4">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-[#353535] text-[16px]">Sophia Chen</p>
                    <p className="text-[12px] text-outline tracking-wider uppercase">Graduate Student, MPhil Cambridge</p>
                  </div>
                </div>
              </div>
              <div className={`pl-6 md:pl-12 border-l-4 border-surface-container-highest text-left transition-all duration-1000 delay-500 transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
                ...
                <p className="font-bold text-[#353535] text-[16px]">Marcus Aurelius Thorne</p>
                <p className="text-[12px] text-outline tracking-wider uppercase">Undergraduate, MIT</p>
              </div>
            </div>
          </div>
        </div>
